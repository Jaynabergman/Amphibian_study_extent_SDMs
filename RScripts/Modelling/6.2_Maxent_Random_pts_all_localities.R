...
LTSA_political_me <- readRDS("./Maxent_Random_pts/LTSA/political/LTSA_political_all_locs/LTSA_political_modelObject_all_locs_random.gz")

## Creating prediction surface 

LTSA_political_surface <- predict(LTSA_political_me, LTSA_political_envi, args = "outputformat=logisitic", progress="", filename=paste(LTSA_political_od,"/LTSA_political_prediction_surface_random",sep=""),format="GTiff")
