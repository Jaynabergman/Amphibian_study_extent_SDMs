...
### Script name: 7.2_independent_AUC_WLNP
...
# Takes extracted prediction values from script "7.1_extract_continuous_surface_predictions_WLNP_sites" 
...
predictions <- read.csv("./Independent_data_and_AUCs/WLNP_data_predictions/predictions_for_WLNP_sites_continuous_surfaces.csv")
...
LTSA_pres_abs <- subset(ind_data, select=c("SiteName", "LTSA", "LTSA_range", "LTSA_political", "LTSA_ecotone"))
...
LTSA_range_r <- rast("./Maxent_Random_pts/LTSA/range/LTSA_range_all_locs/LTSA_range_prediction_surface_random.tif")
plot(LTSA_range_r)
...
LTSA_range_data <- LTSA_pres_abs[,c("SiteName", "LTSA", "LTSA_range")]
...
## saving csv 
write.csv(LTSA_range_values, "./Independent_data_and_AUCs/results/LTSA/40_sites/LTSA_range_validation_40_sites_WLNP.csv", row.names = FALSE)
...
LTSA_political_r <- rast("./Maxent_Random_pts/LTSA/political/LTSA_political_all_locs/LTSA_political_prediction_surface_random.tif")
...
LTSA_political_Threshold <- quantile(LTSA_political_input_predict$LTSA_political_prediction_surface_random, 0.1, na.rm = TRUE)


## Get independent data into usable form for PresenceAbsence package 
## Columns required: 1) ID, 2) Observed status in binary format (0 or 1), 3) prediction values

LTSA_political_data <- LTSA_pres_abs[,c("SiteName", "LTSA", "LTSA_political")]
...
## saving csv 
write.csv(LTSA_political_values, "./Independent_data_and_AUCs/results/LTSA/40_sites/LTSA_political_validation_40_sites_WLNP.csv", row.names = FALSE)
...
LTSA_ecotone_r <- rast("./Maxent_Random_pts/LTSA/ecotone/LTSA_ecotone_all_locs/LTSA_ecotone_prediction_surface_random.tif")
plot(LTSA_ecotone_r)
...
LTSA_ecotone_Threshold <- quantile(LTSA_ecotone_input_predict$layer, 0.1, na.rm = TRUE)


## Get independent data into usable form for PresenceAbsence package 
## Columns required: 1) ID, 2) Observed status in binary format (0 or 1), 3) prediction values

LTSA_ecotone_data <- LTSA_pres_abs[,c("SiteName", "LTSA", "LTSA_ecotone")]
...
## saving csv 
write.csv(LTSA_ecotone_values, "./Independent_data_and_AUCs/results/LTSA/40_sites/LTSA_ecotone_validation_40_sites_WLNP.csv", row.names = FALSE)
...
BCFR_pres_abs <- subset(ind_data, select=c("SiteName", "BCFR", "BCFR_range", "BCFR_political", "BCFR_ecotone"))
...
BCFR_range_r <- rast("./Maxent_Random_pts/BCFR/range/BCFR_range_all_locs/BCFR_range_prediction_surface_random.tif")
plot(BCFR_range_r)
...
BCFR_range_Threshold <- quantile(BCFR_range_input_predict$BCFR_range_prediction_surface_random, 0.1, na.rm = TRUE)


## Get independent data into usable form for PresenceAbsence package 
## Columns required: 1) ID, 2) Observed status in binary format (0 or 1), 3) prediction values

BCFR_range_data <- BCFR_pres_abs[,c("SiteName", "BCFR", "BCFR_range")]
...
## saving csv 
write.csv(BCFR_range_values, "./Independent_data_and_AUCs/results/BCFR/40_sites/BCFR_range_validation_40_sites_WLNP.csv", row.names = FALSE)
...
BCFR_political_r <- rast("./Maxent_Random_pts/BCFR/political/BCFR_political_all_locs/BCFR_political_prediction_surface_random.tif")
...
BCFR_political_Threshold <- quantile(BCFR_political_input_predict$BCFR_political_prediction_surface_random, 0.1, na.rm = TRUE)


## Get independent data into usable form for PresenceAbsence package 
## Columns required: 1) ID, 2) Observed status in binary format (0 or 1), 3) prediction values

BCFR_political_data <- BCFR_pres_abs[,c("SiteName", "BCFR", "BCFR_political")]
...
## saving csv 
write.csv(BCFR_political_values, "./Independent_data_and_AUCs/results/BCFR/40_sites/BCFR_political_validation_40_sites_WLNP.csv", row.names = FALSE)
...
BCFR_ecotone_r <- rast("./Maxent_Random_pts/BCFR/ecotone/BCFR_ecotone_all_locs/BCFR_ecotone_prediction_surface_random.tif")
plot(BCFR_ecotone_r)
...
BCFR_ecotone_Threshold <- quantile(BCFR_ecotone_input_predict$BCFR_ecotone_prediction_surface_random, 0.1, na.rm = TRUE)


## Get independent data into usable form for PresenceAbsence package 
## Columns required: 1) ID, 2) Observed status in binary format (0 or 1), 3) prediction values

BCFR_ecotone_data <- BCFR_pres_abs[,c("SiteName", "BCFR", "BCFR_ecotone")]
...
## saving csv 
write.csv(BCFR_ecotone_values, "./Independent_data_and_AUCs/results/BCFR/40_sites/BCFR_ecotone_validation_40_sites_WLNP.csv", row.names = FALSE)
...
CSFR_pres_abs <- subset(ind_data, select=c("SiteName", "CSFR", "CSFR_range", "CSFR_political", "CSFR_ecotone"))
...
CSFR_range_r <- rast("./Maxent_Random_pts/CSFR/range/CSFR_range_all_locs/CSFR_range_prediction_surface_random.tif")
plot(CSFR_range_r)
...
CSFR_range_Threshold <- quantile(CSFR_range_input_predict$layer, 0.1, na.rm = TRUE)


## Get independent data into usable form for PresenceAbsence package 
## Columns required: 1) ID, 2) Observed status in binary format (0 or 1), 3) prediction values

CSFR_range_data <- CSFR_pres_abs[,c("SiteName", "CSFR", "CSFR_range")]
...
## saving csv 
write.csv(CSFR_range_values, "./Independent_data_and_AUCs/results/CSFR/40_sites/CSFR_range_validation_40_sites_WLNP.csv", row.names = FALSE)
...
CSFR_political_r <- rast("./Maxent_Random_pts/CSFR/political/CSFR_political_all_locs/CSFR_political_prediction_surface_random.tif")
...
CSFR_political_Threshold <- quantile(CSFR_political_input_predict$layer, 0.1, na.rm = TRUE)


## Get independent data into usable form for PresenceAbsence package 
## Columns required: 1) ID, 2) Observed status in binary format (0 or 1), 3) prediction values

CSFR_political_data <- CSFR_pres_abs[,c("SiteName", "CSFR", "CSFR_political")]
...
## saving csv 
write.csv(CSFR_political_values, "./Independent_data_and_AUCs/results/CSFR/40_sites/CSFR_political_validation_40_sites_WLNP.csv", row.names = FALSE)
...
CSFR_ecotone_r <- rast("./Maxent_Random_pts/CSFR/ecotone/CSFR_ecotone_all_locs/CSFR_ecotone_prediction_surface_random.tif")
plot(CSFR_ecotone_r)
...
CSFR_ecotone_Threshold <- quantile(CSFR_ecotone_input_predict$layer, 0.1, na.rm = TRUE)


## Get independent data into usable form for PresenceAbsence package 
## Columns required: 1) ID, 2) Observed status in binary format (0 or 1), 3) prediction values

CSFR_ecotone_data <- CSFR_pres_abs[,c("SiteName", "CSFR", "CSFR_ecotone")]
...
## saving csv 
write.csv(CSFR_ecotone_values, "./Independent_data_and_AUCs/results/CSFR/40_sites/CSFR_ecotone_validation_40_sites_WLNP.csv", row.names = FALSE)
...
WETO_pres_abs <- subset(ind_data, select=c("SiteName", "WETO", "WETO_range", "WETO_political", "WETO_ecotone"))
...
WETO_range_r <- rast("./Maxent_Random_pts/WETO/range/WETO_range_all_locs/WETO_range_prediction_surface_random.tif")
plot(WETO_range_r)
...
WETO_range_Threshold <- quantile(WETO_range_input_predict$layer, 0.1, na.rm = TRUE)


## Get independent data into usable form for PresenceAbsence package 
## Columns required: 1) ID, 2) Observed status in binary format (0 or 1), 3) prediction values

WETO_range_data <- WETO_pres_abs[,c("SiteName", "WETO", "WETO_range")]
...
## saving csv 
write.csv(WETO_range_values, "./Independent_data_and_AUCs/results/WETO/40_sites/WETO_range_validation_40_sites_WLNP.csv", row.names = FALSE)
...
WETO_political_r <- rast("./Maxent_Random_pts/WETO/political/WETO_political_all_locs/WETO_political_prediction_surface_random.tif")
...
WETO_political_Threshold <- quantile(WETO_political_input_predict$layer, 0.1, na.rm = TRUE)


## Get independent data into usable form for PresenceAbsence package 
## Columns required: 1) ID, 2) Observed status in binary format (0 or 1), 3) prediction values

WETO_political_data <- WETO_pres_abs[,c("SiteName", "WETO", "WETO_political")]
...
## saving csv 
write.csv(WETO_political_values, "./Independent_data_and_AUCs/results/WETO/40_sites/WETO_political_validation_40_sites_WLNP.csv", row.names = FALSE)
...
WETO_ecotone_r <- rast("./Maxent_Random_pts/WETO/ecotone/WETO_ecotone_all_locs/WETO_ecotone_prediction_surface_random.tif")
plot(WETO_ecotone_r)
...
WETO_ecotone_Threshold <- quantile(WETO_ecotone_input_predict$layer, 0.1, na.rm = TRUE)


## Get independent data into usable form for PresenceAbsence package 
## Columns required: 1) ID, 2) Observed status in binary format (0 or 1), 3) prediction values

WETO_ecotone_data <- WETO_pres_abs[,c("SiteName", "WETO", "WETO_ecotone")]
...
## saving csv 
write.csv(WETO_ecotone_values, "./Independent_data_and_AUCs/results/WETO/40_sites/WETO_ecotone_validation_40_sites_WLNP.csv", row.names = FALSE)
